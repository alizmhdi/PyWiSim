...
All experiments are reproducible through the evaluation script \texttt{examples/evaluate\_spray\_wait.py}. The script writes the full CSV file and generates the figures included below. The exact experiment in this report can be regenerated with \texttt{python examples/evaluate\_spray\_wait.py --copies 1 2 4 N --trials 50}.
